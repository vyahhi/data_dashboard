...
(function() {
  ...
  plot_timeline = function() {
    d3.json("/data/timeline.json", function(activities) {
      var render;
      render = function() {
        var activity, changeSiblingGuideOpacity, createLine, days, duration, getHlineType, getTimelineTypeSuffix, height, hlineG, line, lineChartHeight, numDays, perdayThreshold, rectSide, selector, sid, svg, togglePerDayReference, tooltip, update, width, y;
        update = function() {
          var y;
