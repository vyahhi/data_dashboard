...
plot_timeline = function(studentID, activities_data) {
  var render;
  render = function() {
    ...
    height = (d3.select(window)[0][0].outerWidth >= 1000 ? d3.select("#progress")[0][0].offsetHeight - 300 : width / 2);
    ...
    days.append("rect").attr("width", rectSide).attr("height", 7).attr("x", function(d, i) {
      return i * rectSide;
